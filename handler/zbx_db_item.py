...
from worker.host_filter import cmdb_host_filter_order_by_item, database_filter_by_cmdb
from conf import settings
from db.zabbix import ZABBIX
from db.mysql import ENGINES


class ZbxDbItemHandler(ZabbixBaseHandler):
    def cmdb_get_args_dict(self, *args, prefix=""):
        res = {}
        for arg in args:
            a = self.get_argument(arg, None)
            try:
    ...
    def get(self):
        ...
        cmdb_filters.update(self.cmdb_get_args_dict(*host_args_key, prefix='cmdb_'))
