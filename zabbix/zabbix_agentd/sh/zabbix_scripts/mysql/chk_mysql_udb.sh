#!/bin/bash
mysqladmin_con="/data/db/mysql-5.6.34/bin/mysqladmin --defaults-extra-file=/data/conf/zabbix-agentd/mysqladmin.cnf -h "$2
mysql_con="/data/db/mysql-5.6.34/bin/mysql --defaults-extra-file=/data/conf/zabbix-agentd/mysqladmin.cnf -h"$2
